...
insert into o_rollcall values(1,'Zoro','Present');
insert into o_rollcall values(2,'Skye','Absent');
insert into o_rollcall values(3,'Nami','Present');
insert into o_rollcall values(4,'Chopper','Absent');
insert into o_rollcall values(5,'Luffy','Present');


select * from o_rollcall;

insert into n_rollcall values(3,'Nami','Present');
insert into n_rollcall values(6,'Ola','Absent');
insert into n_rollcall values(7,'Pronto','Present');
insert into n_rollcall values(8,'Shourya','Absent');
